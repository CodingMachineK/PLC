class Parser:
    ...
    def stmt(self):
        return self.if_stmt() or self.block() or self.assign() or self.declare()
    ...
    def bor(self):
        if self.expr():
            ...
            return True
        return False
tokens = tokens = tokens = ['DataType', 'int', 'ID', '=', 'INT_LIT', ';', 'DataType', 'float', 'ID', '=', 'FLOAT_LIT', ';', 'DataType', 'void', 'main', '(', ')', '{', 'DataType', 'int', 'ID', '=', 'INT_LIT', ';', 'DataType', 'float', 'ID', '=', 'FLOAT_LIT', ';', 'while', '(', 'ID', '<', 'INT_LIT', '&&', 'ID', '>=', 'FLOAT_LIT', ')', '{', 'if', '(', 'ID', '%', '2', '==', '0', ')', '{', 'ID', '=', 'ID', '+', '1', ';', '}', 'else', '{','ID', '=', 'ID', '*', '2', ';', '}', '}', 'return', 'ID', ';', '}']
